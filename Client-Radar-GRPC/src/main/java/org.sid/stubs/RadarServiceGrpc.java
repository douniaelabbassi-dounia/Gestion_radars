package com.mustaphaslimani.stubs;
...
public final class RadarServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.mustaphaslimani.stubs.RadarOuterClass.DetectRequest,
      com.mustaphaslimani.stubs.RadarOuterClass.Infraction> getDetectInfractionMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "DetectInfraction",
      requestType = com.mustaphaslimani.stubs.RadarOuterClass.DetectRequest.class,
      responseType = com.mustaphaslimani.stubs.RadarOuterClass.Infraction.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.mustaphaslimani.stubs.RadarOuterClass.DetectRequest,
      com.mustaphaslimani.stubs.RadarOuterClass.Infraction> getDetectInfractionMethod() {
    io.grpc.MethodDescriptor<com.mustaphaslimani.stubs.RadarOuterClass.DetectRequest, com.mustaphaslimani.stubs.RadarOuterClass.Infraction> getDetectInfractionMethod;
      ...
      synchronized (RadarServiceGrpc.class) {
        if ((getDetectInfractionMethod = RadarServiceGrpc.getDetectInfractionMethod) == null) {
          RadarServiceGrpc.getDetectInfractionMethod = getDetectInfractionMethod = 
              io.grpc.MethodDescriptor.<com.mustaphaslimani.stubs.RadarOuterClass.DetectRequest, com.mustaphaslimani.stubs.RadarOuterClass.Infraction>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "RadarService", "DetectInfraction"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.mustaphaslimani.stubs.RadarOuterClass.DetectRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.mustaphaslimani.stubs.RadarOuterClass.Infraction.getDefaultInstance()))
  ...
  public static abstract class RadarServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void detectInfraction(com.mustaphaslimani.stubs.RadarOuterClass.DetectRequest request,
        io.grpc.stub.StreamObserver<com.mustaphaslimani.stubs.RadarOuterClass.Infraction> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                com.mustaphaslimani.stubs.RadarOuterClass.DetectRequest,
                com.mustaphaslimani.stubs.RadarOuterClass.Infraction>(
  ...
  public static final class RadarServiceBlockingStub extends io.grpc.stub.AbstractStub<RadarServiceBlockingStub> {
    ...
    /**
     */
    public com.mustaphaslimani.stubs.RadarOuterClass.Infraction detectInfraction(com.mustaphaslimani.stubs.RadarOuterClass.DetectRequest request) {
  ...
  public static final class RadarServiceFutureStub extends io.grpc.stub.AbstractStub<RadarServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.mustaphaslimani.stubs.RadarOuterClass.Infraction> detectInfraction(
        com.mustaphaslimani.stubs.RadarOuterClass.DetectRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_DETECT_INFRACTION:
          serviceImpl.detectInfraction((com.mustaphaslimani.stubs.RadarOuterClass.DetectRequest) request,
              (io.grpc.stub.StreamObserver<com.mustaphaslimani.stubs.RadarOuterClass.Infraction>) responseObserver);
          break;
        default:
  ...
  private static abstract class RadarServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.mustaphaslimani.stubs.RadarOuterClass.getDescriptor();
    }
